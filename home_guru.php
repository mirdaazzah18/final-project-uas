    ...
    <div class="container">
      <div class="row">
        <div class="col text-center">
          <h3>Daftar Nilai Semester 1</h3>
        </div>
      </div><br>
      <div class="row">
        <div class="text-end">
          <a href="cetak_excel_guru.php"><button type="button" class="btn btn-outline-primary">Cetak Nilai Excel</button></a>
          <a href="cetak_pdf_guru.php"><button type="button" class="btn btn-outline-primary">Cetak Nilai PDF</button></a>
          <a href="tambahdata.php"><button type="button" class="btn btn-outline-primary">Tambahkan Data</button></a>
          <a href="tambahdata.php"><button type="button" class="btn btn-outline-primary">Ubah Data</button></a>
        </div>
        </div><br>
    ...
    <table border="1" class="table-hover">
      <tr>
        ...
        <th>Pendidikan Jasmani</th>
          ...
          $cari_nilai = mysqli_query($koneksi, "SELECT * FROM nilai_semester1 WHERE id_siswa ='$id_siswa'");
...
<div class="container">
  <div class="row">
    <div class="col text-center">
      <h3>Daftar Nilai Semester 2</h3>
    </div>
  </div><br>
  <div class="row">
    <div class="text-end">
      <a href="cetak_excel_guru1.php"><button type="button" class="btn btn-outline-primary">Cetak Nilai Excel</button></a>
      <a href="cetak_pdf_guru1.php"><button type="button" class="btn btn-outline-primary">Cetak Nilai PDF</button></a>
      <a href="tambahdata1.php"><button type="button" class="btn btn-outline-primary">Tambahkan Data</button></a>
      <a href="tambahdata1.php"><button type="button" class="btn btn-outline-primary">Ubah Data</button></a>
    </div><br>
   		<!-- form di table utk menampilkan data  -->
       <table border="1">
         <tr>
