...
foreach ($siswa as $row) {
  ...
  $query = "UPDATE nilai_semester1 SET agama='$inp_agama', ppkn='$inp_ppkn',  b_indo='$inp_b_indo', matematika='$inp_matematika', ipa='$inp_ipa', ips='$inp_ips', b_ing='$inp_b_ing', b_arab='$inp_b_arab', senbud='$inp_senbud', penjas='$inp_penjas' WHERE id_siswa='$inp_id_siswa'";
